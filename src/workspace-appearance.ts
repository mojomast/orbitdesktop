...
export function applyAppearance(state:Workspace) {
 ...
 if(a.theme==='classic' && a.wallpaper===undefined){target.style.setProperty('background-image','url("/orbit-95.svg")','important');target.style.setProperty('background-size','cover','important');target.style.setProperty('background-position','center','important');}
