...
for(const [name,schema] of Object.entries({'workbench-native-v1':nativeSchema,'workbench-native-tools-v1':nativeToolRequests,'workbench-environments-v1':environmentSchema,'workbench-workflow-v1':workflowSchema})){
