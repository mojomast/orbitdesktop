...
function main(args) {
  ...
  try {if(check.pragma('user_version',{simple:true})!==6)throw Error('Bundle administration requires schema 6; coordinate an offline upgrade before publishing with this version');}finally {check.close();}
